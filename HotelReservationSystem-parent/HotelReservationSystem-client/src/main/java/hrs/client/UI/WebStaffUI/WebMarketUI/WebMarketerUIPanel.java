...
import hrs.client.UI.WebStaffUI.WebMarketUI.WebMarketListener.jbModifyWebMarketerMouseListener;
import hrs.client.UI.WebStaffUI.WebMarketUI.WebMarketListener.jbSearchWebMarketerConfirmMouseListener;
...
public class WebMarketerUIPanel extends JPanel {
	...
	private jbSearchWebMarketerConfirmMouseListener searchWebMarketerConfirmMouseListener;
	private jbModifyWebMarketerMouseListener modifyWebMarketerMouseListener;
	...
	public void init(){
		...
		searchWebMarketerConfirmMouseListener=new jbSearchWebMarketerConfirmMouseListener(this);
		...
		modifyWebMarketerMouseListener=new jbModifyWebMarketerMouseListener(this);
		...
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(jlWebMarketerUsername)
						.addComponent(jtextUsername, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE))
					.addGap(41)
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(jlWebMarketerPassword)
