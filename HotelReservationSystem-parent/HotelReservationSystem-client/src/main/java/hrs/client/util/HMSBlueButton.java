...
public class HMSBlueButton extends JButton{
    /**
	 * 
	 */
    ...
    public static Color COLOR1 = new Color(79, 125, 184);
    public static Color COLOR2 = new Color(89, 200, 240);
    /*光标进入按钮判断*/
    private boolean hover;
    public HMSBlueButton(){
    	this("");
    }
    public HMSBlueButton(String name){
    	super.setText(name);
    ...
    private void paintcolor(Color COLOR1, Color COLOR2){
    	...
    	setFont(new Font("宋体", Font.PLAIN, 19));
